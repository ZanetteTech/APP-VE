...
import { ExternalLink, Trash2, Edit, Save, FileText, Link as LinkIcon, Clock, Plus, RefreshCw, LayoutList } from 'lucide-react';
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="glass-card border-border w-[95%] max-w-4xl h-[90vh] flex flex-col p-0 gap-0">
        ...
        {/* Top Navigation */}
        <div className="flex border-b border-border/50 bg-background/50 backdrop-blur-sm sticky top-0 z-10">
          <button 
